...
public interface BookingService {
    ...
    List<BookingDto> getBookingInfoList(long bookerId, String state, int from, int size);

    List<BookingDto> getBookingOwnerInfoList(long ownerId, String state, int from, int size);
}
