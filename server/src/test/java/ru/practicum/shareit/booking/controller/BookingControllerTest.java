...
class BookingControllerTest {
    ...
    void getBookingInfoList() {
        ...
        when(bookingService.getBookingInfoList(anyLong(), any(BookingRequestState.class), anyInt(), anyInt())).thenReturn(bookingsDto);
    ...
    void getBookingOwnerInfoList() {
        ...
        when(bookingService.getBookingOwnerInfoList(anyLong(), any(BookingRequestState.class), anyInt(), anyInt())).thenReturn(bookingsDto);
