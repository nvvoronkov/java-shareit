...
class BookingServiceTest {
    ...
    void getBookingInfoList() {
        ...
        List<BookingDto> result = bookingService.getBookingInfoList(bookerForTests.getId(), BookingRequestState.ALL, 0, 10);
    ...
    void getBookingOwnerInfoList() {
        ...
        List<BookingDto> result = bookingService.getBookingOwnerInfoList(bookerForTests.getId(), BookingRequestState.ALL, 0, 10);
